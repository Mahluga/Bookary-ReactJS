...
// const Shoping = () => {
//   const [books, setBooks] = useContext(ShopContext);
...
//   useEffect(() => {
//     // For ratings
//     const fiveStar = books.filter((item) => item.star >= 4.4);
...
//     const newAuthor = books.filter((item) => item.author === author);

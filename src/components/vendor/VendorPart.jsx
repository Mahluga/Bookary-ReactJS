...
const VendorPart = () => {
    const [activeCol, setActiveCol] = useState(4);
    ...
    return (
        <Container className='vendor-page'>
            ...
            <Row className="vendors g-4">
                {searchvalue === "" ? vendorData.map((item) => {
                    return activeCol === 4 ?
                ...
                }) : vendorData.filter(value => value.vendorName.toLocaleLowerCase().includes(searchvalue)).map((item) => {
                    return activeCol === 4 ?
                        <Col sm={12} md={4} key={item.id}>
                            <div className="vendor-card">
                                <div className="vendor-header">

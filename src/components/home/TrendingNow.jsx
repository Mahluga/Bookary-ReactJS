...
const TrendingNow = () => {
    ...
    return (
        <div className="trending-now pt-5 d-flex">
            <Container>
                ...
                <Row className='mode-cards gy-4 d-flex' data-aos="fade-up">
                    <Col sm={12} md={8} className='d-flex'>
                        <Slider {...settings} className='d-flex flex-row'>
                            {trend.slice(1,3).map((item) => {
